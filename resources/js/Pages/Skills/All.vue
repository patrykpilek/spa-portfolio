    ...
    <AppLayout title="Skills">
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 text-right">
                ...
                <jet-button @click="acting=true; method='post'; action=route('skills.store');" class="p-3 border-2 border-blue-500 text-blue-500 bg-blue-100 hover:bg-blue-200 font-bold rounded-xl">
                    Add New +
                </jet-button>
                ...
                <jet-modal :show="acting" @close="acting = false" closeable="true">
                    <div class="bg-gray-50 shadow-2xl p-8">
                        <form @submit.prevent="submit" class="flex flex-col items-center p-16">
                            <jet-input v-model="form.name" class="px-5 py-3 w-96 border border-gray-600 rounded" type="text" name="name" placeholder="Skill name"></jet-input>
                            <jet-input-error :message="form.errors.name"/>

                            <select class="w-96 border border-gray-600 rounded mt-5" v-model="form.color" >
                            ...
                            <jet-button class="px-5 py-3 mt-5 w-96 bg-purple-400 justify-center rounded-xl text-sm" :disabled="form.processing" >
